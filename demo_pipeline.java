/*
 * This template was made from Google Cloud Products Templates
 * by Mary Carmack
 *
...
public class TextIOToBigQuery {
  ...
  public interface Options extends DataflowPipelineOptions, JavascriptTextTransformerOptions {
    @Description("gs://health_data123/ce-open/member_data.csv")
    ValueProvider<String> getInputFilePattern();

    void setInputFilePattern(ValueProvider<String> value);

    @Description("gs://health_data123/ce-open/bigquery_schema.js")
    ValueProvider<String> getJSONPath();

    void setJSONPath(ValueProvider<String> value);

    @Description("national-health-club-203501:dataset1.table2")
    ValueProvider<String> getOutputTable();

    void setOutputTable(ValueProvider<String> value);

    @Description("gs://health_data123/ce-open/udf_function.js")
    ...
    @Validation.Required
    @Description("gs://health_data123/ce-open/tmp_dir")
